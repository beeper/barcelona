...
@property(retain, nonatomic) id remoteObject; // @synthesize remoteObject=_remoteObject;
...
- (id)remoteObjectProxyWithTimeoutInSeconds:(double)arg1 errorHandler:(id)arg2;
