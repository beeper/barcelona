...
@interface CNAutocompleteQueryResponsePreparer : NSObject
{
    ...
    id _priorityResultsFuture;
    id _matchingPriorityResultsPromise;
}

+ (id)makeBundleIdentifierOfCurrentProcess;
+ (id)bundleIdentifierOfCurrentProcess;

@property(retain, nonatomic) id matchingPriorityResultsPromise; // @synthesize matchingPriorityResultsPromise=_matchingPriorityResultsPromise;
@property(retain, nonatomic) id priorityResultsFuture; // @synthesize priorityResultsFuture=_priorityResultsFuture;
