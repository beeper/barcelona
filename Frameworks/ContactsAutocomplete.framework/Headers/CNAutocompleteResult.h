...
@property(copy, nonatomic) id ignoreResultBlock; // @synthesize ignoreResultBlock=_ignoreResultBlock;
@property(copy) NSDictionary *userInfo; // @synthesize userInfo=_userInfo;
@property(copy, nonatomic) NSArray *diagnosticLogs; // @synthesize diagnosticLogs=_diagnosticLogs;
@property(copy, nonatomic) id contactProvider; // @synthesize contactProvider=_contactProvider;
@property(copy, nonatomic) id membersProvider; // @synthesize membersProvider=_membersProvider;
