...
@interface IMEventListener : NSObject
{
    ...
    id _target;
    id _completionBlock;
    id _willInvokeCompletion;
    id _didInvokeCompletion;
}
...
@property(copy) id didInvokeCompletion; // @synthesize didInvokeCompletion=_didInvokeCompletion;
@property(copy) id willInvokeCompletion; // @synthesize willInvokeCompletion=_willInvokeCompletion;
@property __weak id target; // @synthesize target=_target;
@property(readonly) unsigned long long eventCount; // @synthesize eventCount=_eventCount;
@property(readonly, nonatomic) NSObject *semaphore; // @synthesize semaphore=_semaphore;
...
- (void)startListeningForEventTarget:(id)arg1 completion:(id)arg2;
- (void)startListeningForEventTarget:(id)arg1 sendStartingEvent:(id)arg2 completion:(id)arg3;
- (void)waitForCompletion;
- (void)_dispatchStartEventBlock:(id)arg1;
