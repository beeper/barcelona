...
@class NSMutableDictionary, NSObject, SDRDiagnosticReporter;

@interface IMMetricsCollector : NSObject
{
    NSObject *_metricsQueue;
    SDRDiagnosticReporter *_diagnosticReporter;
    NSMutableDictionary *_onGoingEventsMap;
}

+ (id)sharedInstance;
@property(retain, nonatomic) NSObject *metricsQueue; // @synthesize metricsQueue=_metricsQueue;
