...
- (void)appendNotificationForEventHandler:(id)arg1 sender:(id)arg2 eventNotificationBlock:(id)arg3;
- (void)pushNotificationForEventHandler:(id)arg1 sender:(id)arg2 eventNotificationBlock:(id)arg3;
- (void)appendNotificationForEventHandler:(id)arg1 eventNotificationBlock:(id)arg2;
- (void)pushNotificationForEventHandler:(id)arg1 eventNotificationBlock:(id)arg2;
