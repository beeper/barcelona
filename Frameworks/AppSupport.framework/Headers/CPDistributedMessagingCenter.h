...
+ (instancetype)_centerNamed:(NSString*)arg1 requireLookupByPID:(BOOL)arg2;
+ (instancetype)pidRestrictedCenterNamed:(NSString*)arg1;
+ (instancetype _Nonnull)centerNamed:(NSString*)arg1;
...
- (void)unregisterForMessageName:(NSString* _Nonnull)arg1;
- (void)sendDelayedReply:(id)arg1 dictionary:(id)arg2;
- (id)delayReply;
- (void)registerForMessageName:(NSString* _Nonnull)arg1 target:(NSObject* _Nonnull)arg2 selector:(SEL _Nonnull)arg3;
- (void)stopServer;
...
- (BOOL)sendMessageName:(NSString* _Nonnull)arg1 userInfo:(id)arg2;
