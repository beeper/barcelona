...
@interface CPBitmapStore : NSObject
{
    ...
    NSObject *_serialQueueRemoveImagesBackground;
    NSObject *_serialQueueRemoveImagesDefault;
    BOOL _lockOnRead;
}
...
- (struct CGImage *)copyAndStoreImageForKey:(id)arg1 inGroup:(id)arg2 withSize:(struct CGSize)arg3 opaque:(BOOL)arg4 scale:(double)arg5 draw:(id)arg6;
- (struct CGImage *)_copyAndStoreImageForKey:(id)arg1 inGroup:(id)arg2 withSize:(struct CGSize)arg3 format:(unsigned char)arg4 scale:(double)arg5 fillMem:(id)arg6 alternateCompletion:(id)arg7;
