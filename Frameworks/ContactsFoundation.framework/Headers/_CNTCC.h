...
- (BOOL)accessCheckAuditToken:(id)arg1 forService:(long long)arg2;
- (BOOL)isAccessRestrictedForService:(long long)arg1;
- (long long)accessPreflightForService:(long long)arg1;
- (void)requestAccessForService:(long long)arg1 completionHandler:(id)arg2;
