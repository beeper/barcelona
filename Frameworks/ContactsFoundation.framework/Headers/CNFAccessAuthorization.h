...
@property(retain, nonatomic) id tcc; // @synthesize tcc=_tcc;
- (id)_readFileData:(int)arg1 offset:(int)arg2 size:(unsigned long long)arg3;
- (BOOL)_isPid:(int)arg1 linkedOnOrAfter:(id)arg2;
...
- (void)requestAuthorizationWithCompletionHandler:(id)arg1;
...
- (void)requestAuthorization:(long long)arg1 completionHandler:(id)arg2;
