...
@property(retain) id  delayToken; // @synthesize delayToken=_delayToken;
...
@property(readonly) id observerScheduler; // @synthesize observerScheduler=_observerScheduler;
