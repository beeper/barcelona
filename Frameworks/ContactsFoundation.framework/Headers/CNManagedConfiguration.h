...
@property(readonly, nonatomic) id profileConnection; // @synthesize profileConnection=_profileConnection;
...
- (id)initWithAuditToken:(id)arg1 managedProfileConnection:(id)arg2;
