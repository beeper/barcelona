...
@interface SOCKDownloadPurgedAttachmentsView : NSView
{
    ...
    id _downloadButtonPressedCallback;
...
@property(copy, nonatomic) id downloadButtonPressedCallback; // @synthesize downloadButtonPressedCallback=_downloadButtonPressedCallback;
