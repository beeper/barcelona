...
@property(retain, nonatomic) NSObject *mapVariableQueue; // @synthesize mapVariableQueue=_mapVariableQueue;
@property(retain, nonatomic) NSObject *mapLoadingQueue; // @synthesize mapLoadingQueue=_mapLoadingQueue;
...
@property(retain) NSObject *scalingQueue; // @synthesize scalingQueue=_scalingQueue;
