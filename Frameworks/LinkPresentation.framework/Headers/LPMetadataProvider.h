...
@class LPAnimatedImageTranscoder, LPFetcherGroup, LPLinkMetadata, LPMetadataProviderSpecialization, NSMutableArray, NSObject, NSString, NSTimer, NSURL, WKWebView;
...
@interface LPMetadataProvider : NSObject
{
    ...
    NSObject *_subresourceFetchGroup;
...
- (void)_postProcessResolvedMetadataWithCompletionHandler:(id)arg1;
...
- (void)cancel;
- (void)_generateSpecializationIfPossibleForCompleteMetadata:(id)arg1 URL:(id)arg2 completionHandler:(id)arg3;
...
- (id)_startFetchingMetadataForWebView:(id)arg1 completionHandler:(id)arg2;
