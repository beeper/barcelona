...
@class LPAudio, LPAudioMetadata, LPIconMetadata, LPImage, LPImageMetadata, LPSpecializationMetadata, LPVideo, LPVideoMetadata, NSArray, NSItemProvider, NSMutableArray, NSObject, NSString, NSURL;
...
- (void)_loadAsynchronousFieldsWithUpdateHandler:(id)arg1;
