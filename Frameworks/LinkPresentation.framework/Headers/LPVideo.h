...
@class AVAsset, AVURLAsset, LPVideoProperties, NSData, NSItemProvider, NSObject, NSString, NSURL;

@interface LPVideo : NSObject
{
    NSData *_data;
    NSObject *_mediaLoadingQueue;
...
- (void)loadAsynchronouslyWithCompletionHandler:(id)arg1;
