...
@property __weak id accountInfoProvider; // @synthesize accountInfoProvider=_accountInfoProvider;
...
- (void)fetchSyncStateStatisticsWithCompletion:(id)arg1;
- (void)fetchSyncStateStatistics;
- (void)_sendSyncStatisticsToEventHandlers:(id)arg1 error:(id)arg2;
- (void)_fetchSyncStateStatistics:(id)arg1;
...
- (void)setCloudKitSyncEnabled:(BOOL)arg1 withCompletion:(id)arg2;
- (void)setCloudKitSyncEnabled:(BOOL)arg1;
- (void)fetchSyncStateAfterClearingErrorsWithRepairSuccess:(BOOL)arg1 completion:(id)arg2;
- (void)fetchSyncStateAfterClearingErrors;
- (void)fetchRampStateWithCompletion:(id)arg1;
- (void)fetchSyncStateWithCompletion:(id)arg1;
...
- (void)visitEventHandlers:(id)arg1;
