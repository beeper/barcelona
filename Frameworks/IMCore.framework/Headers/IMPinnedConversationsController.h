...
@class NSUbiquitousKeyValueStore, NSOrderedSet, IMChat;
...
@property (nonatomic,retain) NSOrderedSet<NSString*>* pinnedConversationIdentifierSet;                        //@synthesize pinnedConversationIdentifierSet=_pinnedConversationIdentifierSet - In the implementation block
...
+(IMPinnedConversationsController* _Nonnull)sharedInstance;
+(id)requiredKeys;
...
-(NSOrderedSet<NSString *> *)pinnedConversationIdentifierSet;
...
-(BOOL)pinnedConversationsContainsChat:(IMChat*)arg1 ;
