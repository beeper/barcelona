...
@interface IMWhitelistController : NSObject
{
    ...
    NSObject *_screenTimeDispatchQueue;
...
@property(retain, nonatomic) NSObject *screenTimeDispatchQueue; // @synthesize screenTimeDispatchQueue=_screenTimeDispatchQueue;
