...
- (void)_disableCache;
- (void)_enableCache;
- (IMAccount*)jabberAccount;
- (IMAccount*)aimAccount;
- (IMAccount*)mostLoggedInAccount;
- (IMAccount*)bestAccountWithCapability:(unsigned long long)arg1;
- (IMAccount*)bestConnectedAccountForService:(id)arg1;
- (IMAccount*)bestActiveAccountForService:(id)arg1;
- (IMAccount*)bestOperationalAccountForService:(id)arg1;
- (IMAccount*)bestAccountForService:(id)arg1;
- (IMAccount*)bestConnectedAccountForService:(id)arg1 withLogin:(id)arg2;
- (IMAccount*)bestActiveAccountForService:(id)arg1 withLogin:(id)arg2;
- (IMAccount*)iMessageAccountForLastAddressedHandle:(id)arg1 simID:(id)arg2;
- (IMAccount*)bestOperationalAccountForService:(id)arg1 withLogin:(id)arg2;
- (IMAccount*)bestAccountForService:(id)arg1 withLogin:(id)arg2;
- (IMAccount*)bestAccountForService:(id)arg1 login:(id)arg2 guid:(id)arg3;
