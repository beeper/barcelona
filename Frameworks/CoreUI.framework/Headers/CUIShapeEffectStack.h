...
+ (id)gradientWithParameters:(id)arg1 inRect:(struct CGRect)arg2;
...
- (id )effectInsetsWithScale:(double)arg1;
...
- (id)imageWithBevelEmbossOfImage:(id)arg1 effect:(id)arg2;
- (id)imageWithExtraShadowOfImage:(id)arg1 effect:(id)arg2;
- (id)imageWithEngraveShadowOfImage:(id)arg1 effect:(id)arg2;
- (id)imageWithOuterGlowOfImage:(id)arg1 effect:(id)arg2;
- (id)imageWithInteriorGradientFillOfImage:(id)arg1 effect:(id)arg2;
- (id)imageWithHueSaturationOfImage:(id)arg1 effect:(id)arg2;
- (id)imageWithColorOverlayOfImage:(id)arg1 effect:(id)arg2;
- (id)image:(id)arg1 withAdjustedOpacity:(float)arg2;
- (id)imageWithInnerShadowOfImage:(id)arg1 effect:(id)arg2;
- (id)imageWithInnerGlowOfImage:(id)arg1 effect:(id)arg2;
