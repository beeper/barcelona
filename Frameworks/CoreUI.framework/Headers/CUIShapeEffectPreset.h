...
- (void)addValue:(id)arg1 forParameter:(unsigned int)arg2 withNewEffectType:(unsigned int)arg3;
- (void)appendValue:(id)arg1 forParameter:(unsigned int)arg2 withEffectType:(unsigned int)arg3;
- (void)addValue:(id)arg1 forParameter:(unsigned int)arg2 withEffectType:(unsigned int)arg3 atEffectIndex:(unsigned long long)arg4;
- (void)getEffectTuples:(id)arg1 count:(unsigned long long *)arg2 atEffectIndex:(unsigned long long)arg3;
- (void)_insertEffectTuple:(id)arg1 atEffectIndex:(unsigned long long)arg2;
- (id)valueForParameter:(unsigned int)arg1 inEffectAtIndex:(unsigned long long)arg2;
- (unsigned int)effectTypeAtIndex:(unsigned long long)arg1;
- (unsigned long long)effectCount;
- (double)effectScale;
- (id)initWithEffectScale:(double)arg1;
- (id)init;
- (id)initWithConstantPreset:(const id)arg1;
