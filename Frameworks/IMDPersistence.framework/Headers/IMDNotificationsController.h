...
+ (id)_displayNameForHandle:(struct _IMDHandleRecordStruct *)arg1 andContact:(id)arg2 suggestionProvider:(id)arg3;
...
- (void)_proceedMostActiveDevice:(BOOL)arg1 isBlockCalled:(char *)arg2 completionHandler:(id)arg3;
- (void)_isMostActiveDeviceWithCompletionBlock:(id)arg1;
