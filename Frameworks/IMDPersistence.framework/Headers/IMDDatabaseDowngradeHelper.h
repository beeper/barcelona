...
- (BOOL)importDataFromWhitetailDatabaseWithSqlOperation:(struct IMDSqlOperation *)arg1 resultBlock:(id)arg2;
- (BOOL)cloneTableContents:(id)arg1 withOperation:(struct IMDSqlOperation *)arg2 resultBlock:(id)arg3;
