...
@interface MPAVController : NSObject
{
    ...
    NSObject *_autoPlayTimeoutSource;
...
@property(retain, nonatomic) id queueController; // @synthesize queueController=_queueController;
@property(retain, nonatomic) id queueCoordinator; // @synthesize queueCoordinator=_queueCoordinator;
...
- (void)_updateCurrentItemDurationSnapshotWithPlayerTime:(id)arg1;
...
- (double)_currentTimeWithPreloadedPlayerTime:(_Bool)arg1 value:(id)arg2;
...
- (void)setCurrentTime:(double)arg1 options:(long long)arg2 completion:(id)arg3;
...
- (_Bool)_setRate:(float)arg1 forScanning:(_Bool)arg2 withItem:(id)arg3 completion:(id)arg4;
- (_Bool)setRate:(float)arg1 completion:(id)arg2;
