...
- (void)setRadioIdentifiersWithBlock:(void (^)(id))arg1;
- (void)setUniversalStoreIdentifiersWithBlock:(void (^)(id))arg1;
- (void)setPersonalStoreIdentifiersWithPersonID:(NSString *)arg1 block:(void (^)(id))arg2;
- (void)setLibraryIdentifiersWithDatabaseID:(NSString *)arg1 block:(void (^)(id))arg2;
@end
