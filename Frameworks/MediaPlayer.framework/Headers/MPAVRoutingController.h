...
@interface MPAVRoutingController : NSObject
{
    ...
    id _playbackDataSource;
    NSString *_presentedBundleID;
    NSString *_representedBundleID;
}

+ (void)_getActiveRouteWithTimeout:(double)arg1 discoveredRoutes:(id)arg2 completion:(id)arg3;
...
+ (id)systemRoute;
+ (void)setActiveRoute:(id)arg1 reason:(id)arg2 completion:(id)arg3;
+ (void)setActiveRoute:(id)arg1 completion:(id)arg2;
+ (void)getActiveRouteWithTimeout:(double)arg1 completion:(id)arg2;
+ (void)getActiveRouteWithCompletion:(id)arg1;
...
@property(nonatomic) __weak id playbackDataSource; // @synthesize playbackDataSource=_playbackDataSource;
...
- (id)_stateDumpObject;
- (_Bool)removePickedRoute:(id)arg1 completion:(id)arg2;
- (_Bool)removePickedRoute:(id)arg1;
- (_Bool)addPickedRoute:(id)arg1 completion:(id)arg2;
- (_Bool)addPickedRoute:(id)arg1;
@property(readonly, nonatomic) _Bool supportsMultipleSelection;
- (_Bool)_pickRoute:(id)arg1 completion:(id)arg2;
- (_Bool)pickRoute:(id)arg1 withPassword:(id)arg2 completion:(id)arg3;
...
- (void)_promptForHijackIfNeeded:(id)arg1 handler:(id)arg2;
...
- (void)selectRoute:(id)arg1 operation:(long long)arg2 completion:(id)arg3;
...
- (void)fetchAvailableRoutesWithCompletionQueue:(id)arg1 completionHandler:(id)arg2;
