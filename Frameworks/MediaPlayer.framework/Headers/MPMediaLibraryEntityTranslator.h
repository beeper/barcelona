...
@interface MPMediaLibraryEntityTranslator : NSObject
{
    ...
    id _allowedItemPredicatesBlock;
    id _entityQueryBlock;
}
...
@property(copy, nonatomic) id entityQueryBlock; // @synthesize entityQueryBlock=_entityQueryBlock;
@property(copy, nonatomic) id allowedItemPredicatesBlock; // @synthesize allowedItemPredicatesBlock=_allowedItemPredicatesBlock;
...
- (id 90d4f7ff)_MLCorePropertiesForPropertySet:(id)arg1 withForeignPropertyBase:(struct ModelPropertyBase *)arg2;
...
- (id 11bc6599)MLCoreSortDescriptorsForModelSortDescriptors:(id)arg1;
- (id 90d4f7ff)MLCorePropertiesForPropertySet:(id)arg1;
...
- (void)mapRelationshipKey:(id)arg1 toModelClass:(Class)arg2 transient:(_Bool)arg3 usingForeignPropertyBase:(struct ModelPropertyBase *)arg4 relationshipValidationProperties:(const map_8b4f5bcf *)arg5 isValidRelationshipHandler:(id)arg6;
...
- (void)mapPropertyKey:(id)arg1 withPropertiesToFetch:(const map_8b4f5bcf *)arg2 propertiesToSort:(const map_8b4f5bcf *)arg3 sortTransformer:(id)arg4 valueTransformer:(id)arg5;
- (void)mapPropertyKey:(id)arg1 withPropertiesToFetch:(const map_8b4f5bcf *)arg2 valueTransformer:(id)arg3;
- (void)mapPropertyKey:(id)arg1 toMLProperty:(struct ModelPropertyBase *)arg2;
- (void)mapIdentifierMLProperties:(const map_8b4f5bcf *)arg1 identifierCreationBlock:(id)arg2;
