...
- (void)mapPropertyKey:(id)arg1 toValueTransformer:(id)arg2;
- (void)mapPropertyKey:(id)arg1 toArtworkValueTransformer:(id)arg2;
- (void)mapPropertyKey:(id)arg1 toMPContentItemSelector:(SEL)arg2;
- (void)mapIdentifierCreationBlock:(id)arg1;
