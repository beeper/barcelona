...
@property(retain, nonatomic) NSObject *notificationTimer; // @synthesize notificationTimer=_notificationTimer;
...
- (void)_startNotificationTimerWithEventHandler:(id)arg1;
