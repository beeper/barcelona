...
- (id)_resizeArtwork:(id)arg1 forCatalog:(id)arg2 toSize:(struct CGSize)arg3 completionHandler:(id)arg4;
...
- (void)getExportableArtworkPropertiesForCatalog:(id)arg1 completionHandler:(id)arg2;
