...
@interface MPStreamingDownloadSessionRequest : NSObject
{
    ...
    id _downloadSessionAlternativeConfigurationOptionsBlock;
}


@property(copy, nonatomic) id downloadSessionAlternativeConfigurationOptionsBlock; // @synthesize downloadSessionAlternativeConfigurationOptionsBlock=_downloadSessionAlternativeConfigurationOptionsBlock;
