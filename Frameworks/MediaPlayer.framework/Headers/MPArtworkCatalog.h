...
- (void)requestExportableArtworkPropertiesWithCompletion:(id)arg1;
- (void)requestExportableArtworkURLWithCompletion:(id)arg1;
...
@property(readonly, nonatomic) id visualIdenticalityIdentifier;
