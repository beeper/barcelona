...
{
    NSObject *_backgroundTaskQueue;
    NSObject *_cloudUpdateQueue;
...
@property(readonly, nonatomic) id artworkDataSource; // @synthesize artworkDataSource=_artworkDataSource;
...
- (void)populateLocationPropertiesOfItemWithIdentifier:(long long)arg1 withPath:(id)arg2 assetProtectionType:(long long)arg3 completionBlock:(id)arg4;
...
- (void)enumerateEntityChangesAfterSyncAnchor:(id)arg1 maximumRevisionType:(long long)arg2 inUsersLibrary:(_Bool)arg3 itemBlock:(id)arg4 collectionBlock:(id)arg5;
...
- (void)enumerateCollectionIdentifiersForQueryCriteria:(id)arg1 ordered:(_Bool)arg2 cancelBlock:(id)arg3 usingBlock:(id)arg4;
- (void)enumerateItemIdentifiersForQueryCriteria:(id)arg1 ordered:(_Bool)arg2 cancelBlock:(id)arg3 usingBlock:(id)arg4;
- (_Bool)recordPlayEventForPlaylistPersistentID:(long long)arg1;
- (_Bool)recordPlayEventForAlbumPersistentID:(long long)arg1;
- (void)_addGlobalPlaylistsToLibraryDatabase:(id)arg1 asLibraryOwned:(_Bool)arg2 completion:(id)arg3;
...
- (void)_importStoreItemElements:(id)arg1 withReferralObject:(id)arg2 andAddTracksToCloudLibrary:(_Bool)arg3 usingCloudAdamID:(long long)arg4 withCompletion:(id)arg5;
...
@property(readonly, nonatomic) id completeMyCollectionArtworkDataSource;
