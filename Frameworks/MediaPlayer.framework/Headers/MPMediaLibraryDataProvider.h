...
@property(readonly, nonatomic) id artworkDataSource;
...
- (id)collectionResultSetForQueryCriteria:(MPMediaQueryCriteria *)arg1;
- (id)itemResultSetForQueryCriteria:(MPMediaQueryCriteria *)arg1;
