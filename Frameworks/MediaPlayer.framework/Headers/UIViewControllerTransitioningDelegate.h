...
- (id)arg1;
- (id)arg1;
- (id)animationControllerForDismissedController:(UIViewController *)arg1;
- (id)animationControllerForPresentedController:(UIViewController *)arg1 presentingController:(UIViewController *)arg2 sourceController:(UIViewController *)arg3;
@end
