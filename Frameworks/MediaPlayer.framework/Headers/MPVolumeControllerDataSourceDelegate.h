...
- (void)volumeControllerDataSource:(id)arg1 didChangeVolumeAudioCategory:(NSString *)arg2;
...
- (void)volumeControllerDataSource:(id)arg1 didChangeVolumeLabel:(NSString *)arg2;
