...
- (void)setRadioIdentifiersWithBlock:(id)arg1;
- (void)setUniversalStoreIdentifiersWithBlock:(id)arg1;
- (void)setPersonalStoreIdentifiersWithPersonID:(id)arg1 block:(id)arg2;
- (void)setLibraryIdentifiersWithDatabaseID:(id)arg1 block:(id)arg2;
- (id)unionSet:(id)arg1;
- (_Bool)hasCommonIdentifierWithIdentifierSet:(id)arg1;
- (_Bool)intersectsSet:(id)arg1;
@property(readonly, nonatomic) id radio;
@property(readonly, nonatomic) id universalStore;
@property(readonly, nonatomic) id personalizedStore;
@property(readonly, nonatomic) id library;
...
- (id)initWithModelKind:(id)arg1 block:(id)arg2;
- (id)_initWithModelKind:(id)arg1 block:(id)arg2;
