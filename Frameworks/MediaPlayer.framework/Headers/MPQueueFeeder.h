...
- (void)getRepresentativeMetadataForPlaybackContext:(id)arg1 completion:(id)arg2;
- (id)supplementalPlaybackContextWithReason:(long long)arg1;
- (long long)supplementalPlaybackContextBehavior;
- (long long)identifierRegistryWithExclusiveAccessReturningInteger:(id)arg1;
- (_Bool)identifierRegistryWithExclusiveAccessReturningBOOL:(id)arg1;
- (id)identifierRegistryWithExclusiveAccessReturningObject:(id)arg1;
- (void)identifierRegistryWithExclusiveAccess:(id)arg1;
