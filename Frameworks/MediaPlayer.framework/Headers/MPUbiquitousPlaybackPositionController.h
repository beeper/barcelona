...
@property(readonly, retain, nonatomic) NSObject *serviceQueue; // @synthesize serviceQueue=_serviceQueue;
@property(readonly, retain, nonatomic) NSObject *queue; // @synthesize queue=_queue;
...
- (void)persistPlaybackPositionMetadataEntity:(id)arg1 isCheckpoint:(_Bool)arg2 completion:(id)arg3;
