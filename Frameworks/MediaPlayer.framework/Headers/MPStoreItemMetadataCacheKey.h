...
+ (void)_slowGetCacheKeyWithRequest:(id)arg1 completionHandler:(id)arg2;
+ (void)_fastGetCacheKeyWithRequest:(id)arg1 completionHandler:(id)arg2;
+ (void)getCacheKeyWithRequest:(id)arg1 completionHandler:(id)arg2;
