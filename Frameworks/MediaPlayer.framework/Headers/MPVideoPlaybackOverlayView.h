...
@property(nonatomic) __weak id videoViewController; // @synthesize videoViewController;
...
- (void)setHidden:(_Bool)arg1 animated:(_Bool)arg2 animateAlongside:(id)arg3 completionBlock:(id)arg4;
