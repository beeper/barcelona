...
enum CBLinkerConstraint: Hashable, Equatable, CustomDebugStringConvertible {
...
struct LinkingOption: CustomDebugStringConvertible {
    static func symbol(_ symbol: String) -> LinkingOption {
        LinkingOption(constraints: [], symbol: symbol)
    }
    
    /// Constraints that must be met for this symbol to be used
    var constraints: [CBLinkerConstraint]
