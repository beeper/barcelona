...
/**
 Parses an original IMMessage, returning an array of messages, where each message is either a rich link or text/attachment component
 */
func ERExtractRichLinks(for message: IMMessage) -> [IMMessage] {
    let text: NSMutableAttributedString = message.text.mutableCopy() as! NSMutableAttributedString
