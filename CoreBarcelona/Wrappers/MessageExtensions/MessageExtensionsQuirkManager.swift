...
func ERAttributedString(forExtensionOptions options: CreatePluginMessage, on eventLoop: EventLoop) -> EventLoopFuture<MessagePartParseResult> {
    ...
    return ERAttributedString(from: parts, on: eventLoop)
}
